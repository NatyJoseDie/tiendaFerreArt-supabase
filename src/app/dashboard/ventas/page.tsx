              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 items-start">
                ...
                />
                 <FormField
                  ...
                  name="hasInvoice"
                  render={({ field }) => (
                    <FormItem className="flex flex-row items-center space-x-3 space-y-0 rounded-md border p-3 h-fit mt-auto"> 
                       <FormControl>
                        <Checkbox
                          checked={field.value}
                ...
                <TableBody>
                  {sales.map((sale) => (
                    <TableRow key={sale.id}>
                      ...
                      <TableCell className="text-xs max-w-[150px] truncate" title={sale.notes ?? undefined}>{sale.notes}</TableCell>
                    </TableRow>
                  ))}
                </TableBody>
              </Table>
